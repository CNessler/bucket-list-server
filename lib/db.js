...
module.exports = {
  ...
  login: function (user) {
    ...
    .then(function (foundUser) {
      console.log('here with foundUser');
      function findFriendArray(foundUser) {
        var friendArray = []
      ...
      return findFriendArray(foundUser)
    })
    .then(function (friendArray) {
      console.log(friendArray, 'HERE WITH FRIEND ARRAY');
      return Users.find({_id: { $in: friendArray }})
    })
    .then(function (pending) {
      console.log(pending, 'pendings found');
